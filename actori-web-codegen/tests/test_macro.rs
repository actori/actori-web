use actori_web::{http, test, web::Path, App, HttpResponse, Responder};
use actori_web_codegen::{connect, delete, get, head, options, patch, post, put, trace};
...
#[get("/test")]
fn auto_async() -> impl Future<Output = Result<HttpResponse, actori_web::Error>> {
    future::ok(HttpResponse::Ok().finish())
}

#[get("/test")]
fn auto_sync() -> impl Future<Output = Result<HttpResponse, actori_web::Error>> {
    future::ok(HttpResponse::Ok().finish())
}
