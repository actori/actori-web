...
use actori_web::http::{header::SET_COOKIE, HeaderValue};
use actori_web::{Error, HttpMessage, ResponseError};
...
///
/// ```rust
/// use actori_session::CookieSession;
