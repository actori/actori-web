//! User sessions.
//!
//! Actori provides a general solution for session management. Session
...
use actori_web::{Error, FromRequest, HttpMessage, HttpRequest};
...
#[cfg(test)]
mod tests {
    use actori_web::{test, HttpResponse};
